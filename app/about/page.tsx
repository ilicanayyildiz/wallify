      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-neutral-700 dark:text-neutral-300 max-w-3xl mx-auto">
              {language === 'tr' 
                ? 'Wallify\'i dünyanın en iyi duvar kağıdı platformu yapmaya adanmış, tutkulu tasarımcılar, geliştiriciler ve yaratıcı profesyonellerden oluşan bir grup.'
                : 'A passionate group of designers, developers, and creative professionals dedicated to making Wallify the best wallpaper platform in the world.'
              }
            </p>
          </div>
          
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6 rounded-2xl bg-white/50 dark:bg-neutral-800/50 border border-neutral-200 dark:border-neutral-700">
              ...
              <h3 className="text-xl font-bold mb-2 text-black dark:text-white">John Doe</h3>
              <p className="text-blue-600 dark:text-blue-400 font-medium mb-2">Founder & CEO</p>
              <p className="text-sm text-neutral-600 dark:text-neutral-400">
                {language === 'tr' 
                  ? 'Dijital sanat ve harika kullanıcı deneyimleri oluşturmaya tutkulu.'
                  : 'Passionate about digital art and building amazing user experiences.'
                }
              </p>
            </div>
            ...
            <div className="text-center p-6 rounded-2xl bg-white/50 dark:bg-neutral-800/50 border border-neutral-200 dark:border-neutral-700">
              ...
              <h3 className="text-xl font-bold mb-2 text-black dark:text-white">Sarah Johnson</h3>
              <p className="text-green-600 dark:text-green-400 font-medium mb-2">
                {language === 'tr' ? 'Tasarım Başkanı' : 'Head of Design'}
              </p>
              <p className="text-sm text-neutral-600 dark:text-neutral-400">
                {language === 'tr' 
                  ? 'Dijital tasarım ve kullanıcı deneyiminde 10+ yıl deneyime sahip yaratıcı direktör.'
                  : 'Creative director with 10+ years in digital design and user experience.'
                }
              </p>
            </div>
            ...
            <div className="text-center p-6 rounded-2xl bg-white/50 dark:bg-neutral-800/50 border border-neutral-200 dark:border-neutral-700">
              ...
              <h3 className="text-xl font-bold mb-2 text-black dark:text-white">Mike Chen</h3>
              <p className="text-purple-600 dark:text-purple-400 font-medium mb-2">
                {language === 'tr' ? 'Baş Geliştirici' : 'Lead Developer'}
              </p>
              <p className="text-sm text-neutral-600 dark:text-neutral-400">
                {language === 'tr' 
                  ? 'Ölçeklenebilir web uygulamaları oluşturmaya tutkulu full-stack geliştirici.'
