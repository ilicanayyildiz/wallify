            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg text-black dark:text-white mb-1">Phone</h3>
                    <p className="text-neutral-700 dark:text-neutral-300">+1 (555) 123-4567</p>
                    <p className="text-sm text-neutral-600 dark:text-neutral-400">Mon-Fri 9AM-6PM EST</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-neutral-700 dark:text-neutral-300">123 Creative Street</p>
                    <p className="text-neutral-700 dark:text-neutral-300">San Francisco, CA 94102</p>
                  </div>
                </div>
